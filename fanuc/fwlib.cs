...
/*-------------------------------------*/
    ...
    public class ODBAXISNAME
    {
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_actf")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_absolute")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_machine")]
        public static extern short cnc_machine(ushort FlibHndl,
            short a, short b, [Out, MarshalAs(UnmanagedType.LPStruct)] ODBAXIS c);

        /* read relative axis position */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_relative")]
        public static extern short cnc_relative(ushort FlibHndl,
            short a, short b, [Out, MarshalAs(UnmanagedType.LPStruct)] ODBAXIS c);

        /* read distance to go */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_distance")]
        public static extern short cnc_distance(ushort FlibHndl,
            short a, short b, [Out, MarshalAs(UnmanagedType.LPStruct)] ODBAXIS c);

        /* read skip position */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_skip")]
        public static extern short cnc_skip(ushort FlibHndl,
            short a, short b, [Out, MarshalAs(UnmanagedType.LPStruct)] ODBAXIS c);

        /* read servo delay value */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_srvdelay")]
        public static extern short cnc_srvdelay(ushort FlibHndl,
            short a, short b, [Out, MarshalAs(UnmanagedType.LPStruct)] ODBAXIS c);

        /* read acceleration/deceleration delay value */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_accdecdly")]
        public static extern short cnc_accdecdly(ushort FlibHndl,
            short a, short b, [Out, MarshalAs(UnmanagedType.LPStruct)] ODBAXIS c);

        /* read all dynamic data */
#if (!ONO8D)
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rddynamic")]
...
#else
    [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint="cnc_rddynamico8")]
    public static extern short cnc_rddynamic(ushort FlibHndl,
        short a, short b, [Out,MarshalAs(UnmanagedType.LPStruct)] ODBDY_1 c);
    [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint="cnc_rddynamico8")]
    public static extern short cnc_rddynamic(ushort FlibHndl,
...
#else
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rddynamic2")]
#endif
...
#else
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_acts")]
#endif
...
#else
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_acts2")]
#endif
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrrelpos")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_prstwkcd")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdmovrlap")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_canmovrlap")]
...
#else
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdspload")]
#endif
...
#else
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdspmaxrpm")]
#endif
...
#else
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdspgear")]
#endif
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_absolute2")]
        public static extern short cnc_absolute2(ushort FlibHndl,
            short a, short b, [Out, MarshalAs(UnmanagedType.LPStruct)] ODBAXIS c);

        /* read relative axis position 2 */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_relative2")]
        public static extern short cnc_relative2(ushort FlibHndl,
            short a, short b, [Out, MarshalAs(UnmanagedType.LPStruct)] ODBAXIS c);

        /* set wire vertival position */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_setvrtclpos")]
        public static extern short cnc_setvrtclpos(ushort FlibHndl, short a);

        /* set wire threading position */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_setthrdngpos")]
        public static extern short cnc_setthrdngpos(ushort FlibHndl);

        /* read tool position */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdposition")]
...
#else
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdspeed")]
#endif
...
#else
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdsvmeter")]
#endif
...
#else
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdspmeter")]
#endif
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rd5axmandt")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rd5axovrlap")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdhndintrpt")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_clr5axpls")]
        public static extern short cnc_clr5axpls(ushort FlibHndl, short a);

        /* read constant surface speed */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdspcss")]
...
#else
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdexecpt")]
#endif
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdaxisdata")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_dwnstart")]
        public static extern short cnc_dwnstart(ushort FlibHndl);

        /* download NC program */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_download")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_cdownload")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_dwnend")]
        public static extern short cnc_dwnend(ushort FlibHndl);

        /* end of downloading NC program 2 */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_dwnend2")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_dwnstart3")]
        public static extern short cnc_dwnstart3(ushort FlibHndl, short a);

        /* start downloading NC program 3 special */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_dwnstart3_f")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_download3")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_dwnend3")]
        public static extern short cnc_dwnend3(ushort FlibHndl);

        /* start downloading NC program 4 */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_dwnstart4")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_download4")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_dwnend4")]
        public static extern short cnc_dwnend4(ushort FlibHndl);

        /* start verification of NC program */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_vrfstart")]
        public static extern short cnc_vrfstart(ushort FlibHndl);

        /* verify NC program */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_verify")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_cdnc")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_dncend")]
        public static extern short cnc_dncend(ushort FlibHndl);

        /* start downloading DNC program 2 */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_dncstart2")]
        public static extern short cnc_dncstart2(ushort FlibHndl, [In, MarshalAs(UnmanagedType.AsAny)] Object a);

        /* download DNC program 2 */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_dnc2")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_dncend2")]
        public static extern short cnc_dncend2(ushort FlibHndl, short a);

        /* read the diagnosis data of DNC operation */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rddncdgndt")]
...
#if (!ONO8D)
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_upstart")]
        public static extern short cnc_upstart(ushort FlibHndl, short a);
#else
    [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint="cnc_upstarto8")]
    public static extern short cnc_upstart( ushort FlibHndl, int a );
#endif

        /* upload NC program */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_upload")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_cupload")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_upend")]
        public static extern short cnc_upend(ushort FlibHndl);

        /* start uploading NC program 3 */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_upstart3")]
        public static extern short cnc_upstart3(ushort FlibHndl, short a, int b, int c);

        /* start uploading NC program special 3 */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_upstart3_f")]
        public static extern short cnc_upstart3_f(ushort FlibHndl,
            short a, [In, MarshalAs(UnmanagedType.AsAny)] Object b, [In, MarshalAs(UnmanagedType.AsAny)] Object c);

    /* upload NC program 3 */
    [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint="cnc_upload3")]
    public static extern short cnc_upload3( ushort FlibHndl, ref int a, [Out,MarshalAs(UnmanagedType.LPStruct)] ODBUP3 b );
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_upend3")]
        public static extern short cnc_upend3(ushort FlibHndl);

        /* start uploading NC program 4 */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_upstart4")]
        public static extern short cnc_upstart4(ushort FlibHndl, short a, [Out, MarshalAs(UnmanagedType.AsAny)] Object b);

        /* upload NC program 4 */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_upload4")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_upend4")]
        public static extern short cnc_upend4(ushort FlibHndl);

        /* read buffer status for downloading/verification NC program */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_buff")]
...
#if (!ONO8D)
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_search")]
        public static extern short cnc_search(ushort FlibHndl, short a);
#else
    [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint="cnc_searcho8")]
    public static extern short cnc_search( ushort FlibHndl, int a );
#endif

        /* search specified program */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_search2")]
        public static extern short cnc_search2(ushort FlibHndl, int a);

        /* delete all programs */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_delall")]
        public static extern short cnc_delall(ushort FlibHndl);

        /* delete specified program */
#if (!ONO8D)
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_delete")]
        public static extern short cnc_delete(ushort FlibHndl, short a);
#else
    [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint="cnc_deleteo8")]
    public static extern short cnc_delete( ushort FlibHndl, int a );
#endif

        /* delete program (area specified) */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_delrange")]
        public static extern short cnc_delrange(ushort FlibHndl, int a, int b);

        /* read program directory */
#if (!ONO8D)
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdprogdir")]
...
#else
    [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint="cnc_rdprogdiro8")]
    public static extern short cnc_rdprogdir( ushort FlibHndl, 
        short a, short b, short c, ushort d, [Out,MarshalAs(UnmanagedType.LPStruct)] PRGDIR e );
#endif
...
#elif WIN64
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdproginfo")]
#else
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdproginfo")]
#endif
...
#if (!ONO8D)
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdprgnum")]
        public static extern short cnc_rdprgnum(ushort FlibHndl, [Out, MarshalAs(UnmanagedType.LPStruct)] ODBPRO a);
#else
    [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint="cnc_rdprgnumo8")]
    public static extern short cnc_rdprgnum( ushort FlibHndl, [Out,MarshalAs(UnmanagedType.LPStruct)] ODBPRO a );
#endif

        /* read program name under execution */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_exeprgname")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdseqnum")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_seqsrch")]
        public static extern short cnc_seqsrch(ushort FlibHndl, int a);

        /* search specified sequence number (2) */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_seqsrch2")]
        public static extern short cnc_seqsrch2(ushort FlibHndl, int a);

        /* rewind cursor of NC program */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rewind")]
...
#else
        /* read block counter */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdblkcount")]
#endif
...
#else
    [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint="cnc_rdexecprog")]
#endif
    public static extern short cnc_rdexecprog( ushort FlibHndl, ref ushort a, out short b, [Out,MarshalAs(UnmanagedType.AsAny)] Object c );
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdmdiprog")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrmdiprog")]
...
#if (!ONO8D)
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdmdipntr")]
        public static extern short cnc_rdmdipntr(ushort FlibHndl, [Out, MarshalAs(UnmanagedType.LPStruct)] ODBMDIP a);
#else
    [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint="cnc_rdmdipntro8")]
    public static extern short cnc_rdmdipntr( ushort FlibHndl, [Out,MarshalAs(UnmanagedType.LPStruct)] ODBMDIP a );
#endif

        /* write execution pointer for MDI operation */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrmdipntr")]
        public static extern short cnc_wrmdipntr(ushort FlibHndl, int a);

        /* register new program */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_newprog")]
        public static extern short cnc_newprog(ushort FlibHndl, int a);

        /* copy program */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_copyprog")]
        public static extern short cnc_copyprog(ushort FlibHndl, int a, int b);

        /* rename program */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_renameprog")]
        public static extern short cnc_renameprog(ushort FlibHndl, int a, int b);

        /* condense program */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_condense")]
        public static extern short cnc_condense(ushort FlibHndl, short a, int b);

        /* merge program */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_mergeprog")]
...
#else
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdactpt")]
#endif
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rduvactpt")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wractpt")]
        public static extern short cnc_wractpt(ushort FlibHndl, int a, short b, ref int c);

        /* line edit (read program) */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdprogline")]
        ...
        /* line edit (read program) */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdprogline2")]
        public static extern short cnc_rdprogline2(ushort FlibHndl,
            int a, uint b, [Out, MarshalAs(UnmanagedType.AsAny)] Object c, ref uint d, ref uint e);

        /* line edit (write program) */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrprogline")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_delprogline")]
        public static extern short cnc_delprogline(ushort FlibHndl, int a, uint b, uint c);

        /* line edit (search string) */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_searchword")]
        ...
        /* line edit (search string) */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_searchresult")]
        public static extern short cnc_searchresult(ushort FlibHndl, out uint a);

        /* line edit (read program by file name) */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdpdf_line")]
        ...
        /* program lock */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_setpglock")]
        public static extern short cnc_setpglock(ushort FlibHndl, int a);

        /* program unlock */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_resetpglock")]
        public static extern short cnc_resetpglock(ushort FlibHndl, int a);

        /* read the status of the program lock */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdpglockstat")]
        public static extern short cnc_rdpglockstat(ushort FlibHndl, out int a, out int b);

        /* create file or directory */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_pdf_add")]
        public static extern short cnc_pdf_add(ushort FlibHndl, [In, MarshalAs(UnmanagedType.AsAny)] Object a);

        /* condense program file */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_pdf_cond")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrpdf_attr")]
        ...
        /* copy program file */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_pdf_copy")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_pdf_del")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrpdf_line")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_pdf_delline")]
        public static extern short cnc_pdf_delline(ushort FlibHndl, [In, MarshalAs(UnmanagedType.AsAny)] Object a, uint b, uint c);

        /* move program file */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_pdf_move")]
        ...
        /* read current program and its pointer */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_pdf_rdactpt")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_pdf_rdmain")]
        public static extern short cnc_pdf_rdmain(ushort FlibHndl, [Out, MarshalAs(UnmanagedType.AsAny)] Object a);

        /* rename file or directory */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_pdf_rename")]
        ...
        /* line edit (search string) */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_pdf_searchword")]
        ...
        /* line edit (search string) */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_pdf_searchresult")]
        public static extern short cnc_pdf_searchresult(ushort FlibHndl, out uint a);

        /* select program file */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_pdf_slctmain")]
        public static extern short cnc_pdf_slctmain(ushort FlibHndl, [In, MarshalAs(UnmanagedType.AsAny)] Object a);

        /* set current program and its pointer */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_pdf_wractpt")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdpdf_inf")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdpdf_drive")]
        public static extern short cnc_rdpdf_drive(ushort FlibHndl, [Out, MarshalAs(UnmanagedType.AsAny)] Object a);

        /* read current directory */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdpdf_curdir")]
        public static extern short cnc_rdpdf_curdir(ushort FlibHndl, short a, [Out, MarshalAs(UnmanagedType.AsAny)] Object b);

        /* set current directory */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrpdf_curdir")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdpdf_subdir")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdpdf_alldir")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdpdf_subdirn")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdtofs")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrtofs")]
        public static extern short cnc_wrtofs(ushort FlibHndl, short a, short b, short c, int d);

        /* read tool offset value(area specified) */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdtofsr")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrtofsr")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdzofs")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrzofs")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdzofsr")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrzofsr")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdmsptype")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrmsptype")]
...
#elif WIN64
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdparam")]
#else
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdparam")]
#endif
        ...
        /* write parameter */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrparam")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdparar")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrparas")]
        public static extern short cnc_wrparas(ushort FlibHndl, short a, [In, MarshalAs(UnmanagedType.AsAny)] Object b);

        /* read setting data */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdset")]
        ...
        /* write setting data */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrset")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdsetr")]
        public static extern short cnc_rdsetr(ushort FlibHndl,
            ref short a, short b, ref short c, ref short d, [Out, MarshalAs(UnmanagedType.AsAny)] Object e);

        /* write setting data(area specified) */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrsets")]
        public static extern short cnc_wrsets(ushort FlibHndl, short a, [In, MarshalAs(UnmanagedType.AsAny)] Object b);

        /* read parameters */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdparam_ext")]
        ...
        /* read parameter */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdparam3")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_start_async_wrparam")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_end_async_wrparam")]
        public static extern short cnc_end_async_wrparam(ushort FlibHndl, out short a);

        /* read cause of busy for async parameter write */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_async_busy_state")]
        public static extern short cnc_async_busy_state(ushort FlibHndl, out short a);

        /* read diagnosis data */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rddiag_ext")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdpitchr")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrpitchr")]
...
#else
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdmacro")]
#endif
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrmacro")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdmacror")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrmacror")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdmacror2")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrmacror2")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdpmacro")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrpmacro")]
        public static extern short cnc_wrpmacro(ushort FlibHndl, int a, int b, short c);

        /* read P code macro variables(area specified) */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdpmacror")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrpmacror")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdpmacror2")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrpmacror2")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdtofsinfo")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdtofsinfo2")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdzofsinfo")]
        public static extern short cnc_rdzofsinfo(ushort FlibHndl, out short a);

        /* read pitch error compensation data information */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdpitchinfo")]
        public static extern short cnc_rdpitchinfo(ushort FlibHndl, out short a);

        /* read custom macro variable information */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdmacroinfo")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdpmacroinfo")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_tofs_rnge")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_zofs_rnge")]
        ...
        /* read validity of work zero offset */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wksft_rnge")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdhsprminfo")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdhsparam")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdgrpid")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdngrp")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdntool")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdlife")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdcount")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rd1length")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdtoolrng")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdtoolgrp")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrcountr")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdusegrpid")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdmaxgrp")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdmaxtool")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdusetlno")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rd1tlifedata")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rd2tlifedata")]
        public static extern short cnc_rd2tlifedata(ushort FlibHndl,
            short a, short b, [Out, MarshalAs(UnmanagedType.LPStruct)] IODBTD c);

        /* write tool life management data(tool data1) */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wr1tlifedata")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wr2tlifedata")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdgrpinfo")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdgrpinfo2")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdgrpinfo3")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdgrpinfo4")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrgrpinfo")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrgrpinfo2")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrgrpinfo3")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_deltlifegrp")]
        public static extern short cnc_deltlifegrp(ushort FlibHndl, short a);

        /* insert tool life management data(tool data) */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_instlifedt")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_deltlifedt")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_clrcntinfo")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdgrpid2")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rd1tlifedat2")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wr1tlifedat2")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdexchgtgrp")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_regtool")]
        ...
        /* new registration of tool management data */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_regtool_f2")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_deltool")]
        public static extern short cnc_deltool(ushort FlibHndl, short a, ref short b);

        /* lead of tool management data */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdtool")]
        ...
        /* lead of tool management data */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdtool_f2")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrtool")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrtool2")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrtool_f2")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_regmagazine")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_delmagazine")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdmagazine")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrmagazine")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_stopophis")]
        public static extern short cnc_stopophis(ushort FlibHndl);

        /* restart logging operation history data */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_startophis")]
        public static extern short cnc_startophis(ushort FlibHndl);

        /* read number of operation history data */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdophisno")]
        public static extern short cnc_rdophisno(ushort FlibHndl, out ushort a);

        /* read operation history data */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdophistry")]
        ...
        /* read operation history data */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdophistry2")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdophistry4")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdalmhisno")]
        public static extern short cnc_rdalmhisno(ushort FlibHndl, out ushort a);

        /* read alarm history data */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdalmhistry")]
        ...
        /* read alarm history data */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdalmhistry_w")]
        public static extern short cnc_rdalmhistry_w(ushort FlibHndl,
            ushort a, ushort b, ushort c, [Out, MarshalAs(UnmanagedType.LPStruct)] ODBAHIS d);

        /* read alarm history data */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdalmhistry2")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdalmhistry3")]
        ...
        /* read alarm history data F30i*/
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdalmhistry5")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_clearophis")]
        public static extern short cnc_clearophis(ushort FlibHndl, short a);

        /* read signals related operation history */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdhissgnl")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdhissgnl2")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdhissgnl3")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrhissgnl")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrhissgnl2")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrhissgnl3")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdomhisno")]
...
#else
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_sysinfo")]
#endif
...
#else
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_statinfo")]
#endif
        public static extern short cnc_statinfo(ushort FlibHndl, [Out, MarshalAs(UnmanagedType.LPStruct)] ODBST a);

        /* read alarm status */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_alarm")]
        public static extern short cnc_alarm(ushort FlibHndl, [Out, MarshalAs(UnmanagedType.LPStruct)] ODBALM a);

        /* read alarm status */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_alarm2")]
        public static extern short cnc_alarm2(ushort FlibHndl, out int a);

        /* read alarm information */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdalminfo")]
...
#else
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdalmmsg")]
#endif
...
#else
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdalmmsg2")]
#endif
        ...
        /* clear CNC alarm */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_clralm")]
...
#else
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_modal")]
#endif
        ...
        /* read G code */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdgcode")]
        ...
        /* read command value */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdcommand")]
...
#else
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_diagnoss")]
#endif
...
#else
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_diagnosr")]
#endif
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_adcnv")]
...
#else
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_setpath")]
#endif
...
#else
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_getpath")]
#endif
        public static extern short cnc_getpath(ushort FlibHndl, out short a, out short b);

        /* allocate library handle */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_allclibhndl")]
...
#else
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_freelibhndl")]
#endif
        public static extern short cnc_freelibhndl(ushort FlibHndl);

        /* get library option */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_getlibopt")]
        public static extern short cnc_getlibopt(ushort FlibHndl, int a, [Out, MarshalAs(UnmanagedType.AsAny)] Object b, ref int c);

        /* set library option */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_setlibopt")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_getmactype")]
        public static extern short cnc_getmactype(ushort FlibHndl, out short a);

        /* set custom macro type */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_setmactype")]
        public static extern short cnc_setmactype(ushort FlibHndl, short a);

        /* get P code macro type */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_getpmactype")]
        public static extern short cnc_getpmactype(ushort FlibHndl, out short a);

        /* set P code macro type */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_setpmactype")]
        public static extern short cnc_setpmactype(ushort FlibHndl, short a);

        /* get screen status */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_getcrntscrn")]
        public static extern short cnc_getcrntscrn(ushort FlibHndl, out short a);

        /* change screen mode */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_slctscrn")]
        public static extern short cnc_slctscrn(ushort FlibHndl, short a);

        /* read CNC configuration information */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_sysconfig")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdprstrinfo")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rstrseqsrch")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rstrseqsrch2")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdopnlsgnl")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wropnlsgnl")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdopnlgnrl")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wropnlgnrl")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdopnlgsname")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wropnlgsname")]
        public static extern short cnc_wropnlgsname(ushort FlibHndl, [In, MarshalAs(UnmanagedType.LPStruct)] IODBRDNA a);

        /* get detail error */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_getdtailerr")]
...
#elif WIN64
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdparainfo")]
#else
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdparainfo")]
#endif
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdsetinfo")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rddiaginfo")]
...
#elif WIN64
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdparanum")]
#else
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdparanum")]
#endif
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdsetnum")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rddiagnum")]
...
#else
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_getfigure")]
#endif
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdfrominfo")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_fromsvstart")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_fromsave")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_fromsvend")]
        public static extern short cnc_fromsvend(ushort FlibHndl);

        /* start of writing F-ROM data to CNC */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_fromldstart")]
        public static extern short cnc_fromldstart(ushort FlibHndl, short a, int b);

        /* write F-ROM data to CNC */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_fromload")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_fromldend")]
        public static extern short cnc_fromldend(ushort FlibHndl);

        /* delete F-ROM data on CNC */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_fromdelete")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdsraminfo")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_srambkstart")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_srambackup")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_srambkend")]
        public static extern short cnc_srambkend(ushort FlibHndl);

        /* read F-ROM information on CNC  */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_getfrominfo")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_sramgetstart2")]
        public static extern short cnc_sramgetstart2(ushort FlibHndl, [In, MarshalAs(UnmanagedType.AsAny)] Object a);

        /* read S-RAM data from CNC */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_sramget")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_getlockstat")]
        public static extern short cnc_getlockstat(ushort FlibHndl, short a, out byte b);

        /* change NC data protection status */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_chgprotbit")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_dtsvftpget")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_dtsvftpput")]
        public static extern short cnc_dtsvftpput(ushort FlibHndl,
            [In, MarshalAs(UnmanagedType.AsAny)] Object a, [In, MarshalAs(UnmanagedType.AsAny)] Object b);

        /* get transfer status for FTP */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_dtsvftpstat")]
        public static extern short cnc_dtsvftpstat(ushort FlibHndl);

        /* read file directory in Data Server */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_dtsvrdpgdir")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_dtsvdelete")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_dtsvdownload")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_dtsvupload")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_dtsvcnclupdn")]
        public static extern short cnc_dtsvcnclupdn(ushort FlibHndl);

        /* get transfer status for up/down load */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_dtsvupdnstat")]
        public static extern short cnc_dtsvupdnstat(ushort FlibHndl);

        /* get file name for DNC operation in Data Server */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_dtsvgetdncpg")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_dtsvsetdncpg")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_dtsvrdset")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_dtsvwrset")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_dtsvchkdsk")]
        public static extern short cnc_dtsvchkdsk(ushort FlibHndl);

        /* format hard disk in Data Server */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_dtsvhdformat")]
        public static extern short cnc_dtsvhdformat(ushort FlibHndl);

        /* save interface area in Data Server */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_dtsvsavecram")]
        public static extern short cnc_dtsvsavecram(ushort FlibHndl);

        /* get interface area in Data Server */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_dtsvrdcram")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_dtsvmntinfo")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_dtsvgetmode")]
        public static extern short cnc_dtsvgetmode(ushort FlibHndl, out short a);

        /* set Data Server mode */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_dtsvsetmode")]
        public static extern short cnc_dtsvsetmode(ushort FlibHndl, short a);

        /* read error message for Data Server */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_dtsvrderrmsg")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_dtsvwrfile")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_dtsvrdfile")]
        public static extern short cnc_dtsvrdfile(ushort FlibHndl,
            [In, MarshalAs(UnmanagedType.AsAny)] Object a, [In, MarshalAs(UnmanagedType.AsAny)] Object b, short c);

        /* read the loop gain for each axis */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdloopgain")]
        public static extern short cnc_rdloopgain(ushort FlibHndl, out int a);

        /* read the actual current for each axis */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdcurrent")]
        public static extern short cnc_rdcurrent(ushort FlibHndl, out short a);

        /* read the actual speed for each axis */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdsrvspeed")]
...
#else
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdopmode")]
#endif
        public static extern short cnc_rdopmode(ushort FlibHndl, out short a);

        /* read the position deviation S */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdposerrs")]
        public static extern short cnc_rdposerrs(ushort FlibHndl, out int a);

        /* read the position deviation S1 and S2 */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdposerrs2")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdposerrz")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdsynerrsy")]
        public static extern short cnc_rdsynerrsy(ushort FlibHndl, out int a);

        /* read the synchronous error in the rigid tap mode */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdsynerrrg")]
        public static extern short cnc_rdsynerrrg(ushort FlibHndl, out int a);

        /* read the spindle alarm */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdspdlalm")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdctrldi")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdctrldo")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdnspdl")]
        public static extern short cnc_rdnspdl(ushort FlibHndl, out short a);

        /* read data from FANUC BUS */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdfbusmem")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrfbusmem")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdwaveprm")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrwaveprm")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdwaveprm2")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrwaveprm2")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wavestart")]
        public static extern short cnc_wavestart(ushort FlibHndl);

        /* stop the sampling for wave diagnosis */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wavestop")]
        public static extern short cnc_wavestop(ushort FlibHndl);

        /* read the status of wave diagnosis */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wavestat")]
        public static extern short cnc_wavestat(ushort FlibHndl, out short a);

        /* read the data of wave diagnosis */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdwavedata")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdrmtwaveprm")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrrmtwaveprm")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rmtwavestart")]
        public static extern short cnc_rmtwavestart(ushort FlibHndl);

        /* stop the sampling for wave diagnosis for remort diagnosis */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rmtwavestop")]
        public static extern short cnc_rmtwavestop(ushort FlibHndl);

        /* read the status of wave diagnosis for remort diagnosis*/
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rmtwavestat")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdrmtwavedt")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdsavsigadr")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrsavsigadr")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdsavsigdata")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdmgrpdata")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrmgrpdata")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdexecmcode")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdrstrmcode")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdproctime")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdmdiprgstat")]
        public static extern short cnc_rdmdiprgstat(ushort FlibHndl, out ushort a);

        /* read program directory for processing time data */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdprgdirtime")]
...
#if (!ONO8D)
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdprogdir2")]
...
#else
    [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint="cnc_rdprogdir2o8")]
    public static extern short cnc_rdprogdir2( ushort FlibHndl,
        short a, ref short b, ref short c, [Out,MarshalAs(UnmanagedType.LPStruct)] PRGDIR2 d );
#endif

        /* read program directory 3 */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdprogdir3")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdprogdir4")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rddncfname")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrdncfname")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdcomparam")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrcomparam")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdcomlogmsg")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdcomopemsg")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdrcvmsg")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdsndmsg")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_sendmessage")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_clrmsgbuff")]
        public static extern short cnc_clrmsgbuff(ushort FlibHndl, short a);

        /* read message recieve status for OSI-Ethernet */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdrcvstat")]
        public static extern short cnc_rdrcvstat(ushort FlibHndl, out ushort a);

        /* read interference check */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdintchk")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrintchk")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdintinfo")]
        public static extern short cnc_rdintinfo(ushort FlibHndl, out short a);

        /* read work coordinate shift */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdwkcdshft")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrwkcdshft")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdwkcdsfms")]
        public static extern short cnc_rdwkcdsfms(ushort FlibHndl,
            short a, short b, [Out, MarshalAs(UnmanagedType.LPStruct)] IODBWCSF c);

        /* write work coordinate shift measure */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrwkcdsfms")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_stopomhis")]
        public static extern short cnc_stopomhis(ushort FlibHndl);

        /* start the sampling for operator message history */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_startomhis")]
        public static extern short cnc_startomhis(ushort FlibHndl);

        /* read operator message history information */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdomhisinfo")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdomhistry")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdomhistry2")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrkeyhistry")]
        public static extern short cnc_wrkeyhistry(ushort FlibHndl, byte a);

        /* clear operator message history */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_clearomhis")]
        public static extern short cnc_clearomhis(ushort FlibHndl);

        /* read b-axis tool offset value(area specified) */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdbtofsr")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrbtofsr")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdbtofsinfo")]
        public static extern short cnc_rdbtofsinfo(ushort FlibHndl, [Out, MarshalAs(UnmanagedType.LPStruct)] ODBBTLINF a);

        /* read b-axis command */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdbaxis")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdsyssoft")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdsyssoft2")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdmdlconfig")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdmdlconfig2")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdpscdproc")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrpscdproc")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdpscdpirc")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrpscdpirc")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdpscdedge")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrpscdedge")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdpscdslop")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrpscdslop")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdlpwrdty")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrlpwrdty")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdlpwrdat")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdlpwrcpst")]
        public static extern short cnc_rdlpwrcpst(ushort FlibHndl, out short a);

        /* write power complement */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrlpwrcpst")]
        public static extern short cnc_wrlpwrcpst(ushort FlibHndl, short a);

        /* read laser assist gas selection */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdlagslt")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrlagslt")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdlagst")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrlagst")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdledgprc")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrledgprc")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdlprcprc")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrlprcprc")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdlcmddat")]
        public static extern short cnc_rdlcmddat(ushort FlibHndl, [Out, MarshalAs(UnmanagedType.LPStruct)] ODBLCMDT a);

        /* read displacement */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdldsplc")]
        public static extern short cnc_rdldsplc(ushort FlibHndl, out short a);

        /* write displacement */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrldsplc")]
        public static extern short cnc_wrldsplc(ushort FlibHndl, short a);

        /* read error for axis z */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdlerrz")]
        public static extern short cnc_rdlerrz(ushort FlibHndl, out short a);

        /* read active number */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdlactnum")]
        public static extern short cnc_rdlactnum(ushort FlibHndl, [Out, MarshalAs(UnmanagedType.LPStruct)] ODBLACTN a);

        /* read laser comment */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdlcmmt")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdlpwrslt")]
        public static extern short cnc_rdlpwrslt(ushort FlibHndl, out short a);

        /* write laser power select */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrlpwrslt")]
        public static extern short cnc_wrlpwrslt(ushort FlibHndl, short a);

        /* read laser power controll */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdlpwrctrl")]
        public static extern short cnc_rdlpwrctrl(ushort FlibHndl, out short a);

        /* write laser power controll */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrlpwrctrl")]
        public static extern short cnc_wrlpwrctrl(ushort FlibHndl, short a);

        /* read power correction factor history data */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdpwofsthis")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdmngtime")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrmngtime")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rddischarge")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rddischrgalm")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_gettimer")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_settimer")]
...
#else
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdtimer")]
#endif
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrtimer")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdtlctldata")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrtlctldata")]
        public static extern short cnc_wrtlctldata(ushort FlibHndl, [In, MarshalAs(UnmanagedType.LPStruct)] IODBTLCTL a);

        /* read tool data */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdtooldata")]
        ...
        /* read tool data */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrtooldata")]
        public static extern short cnc_wrtooldata(ushort FlibHndl,
            short a, ref short b, [Out, MarshalAs(UnmanagedType.LPStruct)] IODBTLDT c);

        /* read multi tool data */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdmultitldt")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrmultitldt")]
        ...
        /* read multi tap data */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdmtapdata")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrmtapdata")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdmultipieceno")]
        public static extern short cnc_rdmultipieceno(ushort FlibHndl, out int a);

        /* read tool information */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdtoolinfo")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdsafetyzone")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrsafetyzone")]
        ...
        /* read toolzone data */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdtoolzone")]
        ...
        /* write toolzone data */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrtoolzone")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdacttlzone")]
        public static extern short cnc_rdacttlzone(ushort FlibHndl, [Out, MarshalAs(UnmanagedType.LPStruct)] ODBACTTLZN a);

        /* read setzone number */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdsetzone")]
        public static extern short cnc_rdsetzone(ushort FlibHndl, out short a);

        /* write setzone number */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrsetzone")]
        public static extern short cnc_wrsetzone(ushort FlibHndl, short a);

        /* read block restart information */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdbrstrinfo")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdmenuswitch")]
        public static extern short cnc_rdmenuswitch(ushort FlibHndl, out short a);

        /* write menu switch signal */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrmenuswitch")]
        public static extern short cnc_wrmenuswitch(ushort FlibHndl, short a, short b);

        /* read tool radius offset for position data */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdradofs")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdlenofs")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdfixcycle")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdcdrotate")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rd3dcdcnv")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdmirimage")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdscaling")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rd3dtofs")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdposofs")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdhpccset")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrhpccset")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_hpccatset")]
        public static extern short cnc_hpccatset(ushort FlibHndl);

        /* read hpcc tuning data ( parameter input ) */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdhpcctupr")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrhpcctupr")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdhpcctuac")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrhpcctuac")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rd3dtooltip")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rd3dpulse")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rd3dmovrlap")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rd3dofschg")]
        public static extern short cnc_rd3dofschg(ushort FlibHndl, ref int a);

        /* clear pulse and change offset for 3D handle */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_clr3dplsmov")]
        public static extern short cnc_clr3dplsmov(ushort FlibHndl, short a);

        /* cycle start */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_start")]
        public static extern short cnc_start(ushort FlibHndl);

        /* reset CNC */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_reset")]
        public static extern short cnc_reset(ushort FlibHndl);

        /* reset CNC 2 */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_reset2")]
...
#else
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdaxisname")]
#endif
...
#else
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdspdlname")]
#endif
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_exaxisname")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdcexesram")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrcexesram")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_cexesraminfo")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrunsolicprm")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdunsolicprm")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_unsolicstart")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_unsolicstop")]
        public static extern short cnc_unsolicstop(ushort FlibHndl, short a);

        /* Reads the unsolicited message data */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdunsolicmsg")]
        public static extern short cnc_rdunsolicmsg(short a, [In, Out] IDBUNSOLICMSG b);

        /* read machine specific maintenance item */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdpm_mcnitem")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrpm_mcnitem")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdpm_cncitem")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdpm_item")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrpm_item")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_dispoptmsg")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_optmsgans")]
        public static extern short cnc_optmsgans(ushort FlibHndl, out short a);

        /* Get CNC Model */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_getcncmodel")]
        public static extern short cnc_getcncmodel(ushort FlibHndl, out short a);

        /* read number of repeats */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdrepeatval")]
        public static extern short cnc_rdrepeatval(ushort FlibHndl, out int a);

        /* read CNC system hard info */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdsyshard")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdsyssoft3")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_progdigit")]
        public static extern short cnc_progdigit(ushort FlibHndl, out short a);

        /* read CNC system path information */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_sysinfo_ex")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_srcsrsvchnl")]
        public static extern short cnc_srcsrsvchnl(ushort FlibHndl);

        /* Read ID information of SERCOS I/F */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_srcsrdidinfo")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_srcswridinfo")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_srcsstartrd")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_srcsstartwrt")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_srcsstopexec")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_srcsrdexstat")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_srcsrdopdata")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_srcswropdata")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_srcsfreechnl")]
        public static extern short cnc_srcsfreechnl(ushort FlibHndl);

        /* Read drive assign of SERCOS I/F */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_srcsrdlayout")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_srcsrddrvcp")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_startdrawpos")]
        public static extern short cnc_startdrawpos(ushort FlibHndl);

        /* Stop drawing position */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_stopdrawpos")]
        public static extern short cnc_stopdrawpos(ushort FlibHndl);

        /* Start dynamic graphic */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_startdyngrph")]
        public static extern short cnc_startdyngrph(ushort FlibHndl);

        /* Stop dynamic graphic */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_stopdyngrph")]
        public static extern short cnc_stopdyngrph(ushort FlibHndl);

        /* Read graphic command data */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdgrphcmd")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrgrphcmdptr")]
        public static extern short cnc_wrgrphcmdptr(ushort FlibHndl, short a);

        /* Read cancel flag */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdgrphcanflg")]
        public static extern short cnc_rdgrphcanflg(ushort FlibHndl, out short a);

        /* Clear graphic command */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_clrgrphcmd")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_svdtwrdata")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_sdsetchnl")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_sdclrchnl")]
        public static extern short cnc_sdclrchnl(ushort FlibHndl);

        /* Servo Guide (Sampling start) */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_sdstartsmpl")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_sdcancelsmpl")]
        public static extern short cnc_sdcancelsmpl(ushort FlibHndl);

        /* Servo Guide (read Sampling data) */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_sdreadsmpl")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_sdendsmpl")]
        public static extern short cnc_sdendsmpl(ushort FlibHndl);

        /* Servo Guide (read 1 shot data) */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_sdread1shot")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_sfbsetchnl")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_sfbclrchnl")]
        public static extern short cnc_sfbclrchnl(ushort FlibHndl);

        /* Servo feedback data (Sampling start) */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_sfbstartsmpl")]
        public static extern short cnc_sfbstartsmpl(ushort FlibHndl, short a, int b);

        /* Servo feedback data (Sampling cancel) */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_sfbcancelsmpl")]
        public static extern short cnc_sfbcancelsmpl(ushort FlibHndl);

        /* Servo feedback data (read Sampling data) */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_sfbreadsmpl")]
        public static extern short cnc_sfbreadsmpl(ushort FlibHndl,
            out short a, int b, [Out, MarshalAs(UnmanagedType.LPStruct)] ODBSD c);

        /* Servo feedback data (Sampling end) */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_sfbendsmpl")]
        ...
        /* Start NC display */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_startnccmd")]
        public static extern short cnc_startnccmd(ushort FlibHndl);

        /* Start NC display (2) */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_startnccmd2")]
        public static extern short cnc_startnccmd2(ushort FlibHndl, [In, MarshalAs(UnmanagedType.AsAny)] Object a);

        /* Stop NC display */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_stopnccmd")]
        public static extern short cnc_stopnccmd(ushort FlibHndl);

        /* Get NC display mode */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_getdspmode")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_startrmtdgn")]
        public static extern short cnc_startrmtdgn(ushort FlibHndl);

        /* Stop remote diagnostics function */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_stoprmtdgn")]
        public static extern short cnc_stoprmtdgn(ushort FlibHndl);

        /* Read data from remote diagnostics I/F */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdrmtdgn")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrrmtdgn")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrcommstatus")]
        public static extern short cnc_wrcommstatus(ushort FlibHndl, short a);

        /* Check remote diagnostics I/F */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_chkrmtdgn")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_startgetdgdat")]
        public static extern short cnc_startgetdgdat(ushort FlibHndl);

        /* Teaching data get stop */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_stopgetdgdat")]
        public static extern short cnc_stopgetdgdat(ushort FlibHndl);

        /* Teaching data read */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rddgdat")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrdgdatptr")]
        public static extern short cnc_wrdgdatptr(ushort FlibHndl, short a);

        /* Teaching data clear */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_clrdgdat")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_opencexefile")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_closecexefile")]
        public static extern short cnc_closecexefile(ushort FlibHndl);

        /* read C-EXE SRAM file */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdcexefile")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_wrcexefile")]
        public static extern short cnc_wrcexefile(ushort FlibHndl, [In, MarshalAs(UnmanagedType.AsAny)] Object a, ref uint b);

        /* read C-EXE SRAM disk directory */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_cexedirectory")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_rdmsg")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_wrmsg")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_crdmsg")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_cwrmsg")]
...
#else
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_rdpmcrng")]
#endif
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_wrpmcrng")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_rdkpm")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_wrkpm")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_rdkpm2")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_wrkpm2")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_kpmsiz")]
        public static extern short pmc_kpmsiz(ushort FlibHndl, out uint a);

        /* read informations of PMC data */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_rdpmcinfo")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_rdcntldata")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_wrcntldata")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_rdcntlgrp")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_wrcntlgrp")]
        public static extern short pmc_wrcntlgrp(ushort FlibHndl, short a);

        /* read PMC alarm message */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_rdalmmsg")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_getdtailerr")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_rdpmcmem")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_wrpmcmem")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_rdpmcsemem")]
        public static extern short pmc_rdpmcsemem(ushort FlibHndl,
            short a, int b, int c, [Out, MarshalAs(UnmanagedType.AsAny)] Object d);

        /* write PMC-SE memory data */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_wrpmcsemem")]
        public static extern short pmc_wrpmcsemem(ushort FlibHndl,
            short a, int b, int c, [In, MarshalAs(UnmanagedType.AsAny)] Object d);

        /* read pmc title data */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_rdpmctitle")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_rdprmstart")]
        public static extern short pmc_rdprmstart(ushort FlibHndl);

        /* read PMC parameter */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_rdpmcparam")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_rdprmend")]
        public static extern short pmc_rdprmend(ushort FlibHndl);

        /* write PMC parameter start */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_wrprmstart")]
        public static extern short pmc_wrprmstart(ushort FlibHndl);

        /* write PMC parameter */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_wrpmcparam")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_wrprmend")]
        public static extern short pmc_wrprmend(ushort FlibHndl);

        /* read PMC data */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_rdpmcrng_ext")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_wriolinkdat")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_rdpmcaddr")]
        public static extern short pmc_rdpmcaddr(ushort FlibHndl, [Out, MarshalAs(UnmanagedType.LPStruct)] ODBPMCADR a);

        /* select PMC unit */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_select_pmc_unit")]
        public static extern short pmc_select_pmc_unit(ushort FlibHndl, int a);

        /* get current PMC unit */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_get_current_pmc_unit")]
        public static extern short pmc_get_current_pmc_unit(ushort FlibHndl, ref int a);

        /* get number of PMC */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_get_number_of_pmc")]
        public static extern short pmc_get_number_of_pmc(ushort FlibHndl, ref int a);

        /* get PMC unit types */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_get_pmc_unit_types")]
        public static extern short pmc_get_pmc_unit_types(ushort FlibHndl, int[] a, ref int b);

        /* set PMC Timer type */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_set_timer_type")]
        public static extern short pmc_set_timer_type(ushort FlibHndl, ushort a, ushort b, ref short c);

        /* get PMC Timer type */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_get_timer_type")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_prfrdconfig")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_prfrdbusprm")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_prfwrbusprm")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_prfrdslvprm")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_prfwrslvprm")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_prfrdallcadr")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_prfwrallcadr")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_prfrdslvaddr")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_prfwrslvaddr")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_prfrdslvstat")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_prfrdslvid")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_prfwrslvid")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_prfrdslvprm2")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_prfwrslvprm2")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_prfrddido")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_prfwrdido")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_prfrdindiadr")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_prfwrindiadr")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_prfrdopmode")]
        public static extern short pmc_prfrdopmode(ushort FlibHndl, ref short a);

        /* Writes operation mode of master function */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "pmc_prfwropmode")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "etb_rdparam")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "etb_wrparam")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "etb_rderrmsg")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_rdmode")]
        public static extern short ds_rdmode(ushort FlibHndl, ref short a);

        /* write the mode of the Data Server */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_wrmode")]
        public static extern short ds_wrmode(ushort FlibHndl, short a);

        /* read information of the Data Server's HDD */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_rdhddinfo")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_rdhdddir")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_delhddfile")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_copyhddfile")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_renhddfile")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_puthddfile")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_mputhddfile")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_rdhostinfo")]
        public static extern short ds_rdhostinfo(ushort FlibHndl, out int a, int b);

        /* read the file list of the host */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_rdhostdir")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_rdhostdir2")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_delhostfile")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_gethostfile")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_mgethostfile")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_rdresult")]
        public static extern short ds_rdresult(ushort FlibHndl);

        /* stop the execution of the command */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_cancel")]
        public static extern short ds_cancel(ushort FlibHndl);

        /* read the file from the Data Server */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_rdncfile")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_rdncfile2")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_wrncfile")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_rddnchddfile")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_wrdnchddfile")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_rddnchostfile")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_wrdnchostfile")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_rdhostno")]
        public static extern short ds_rdhostno(ushort FlibHndl, out short a);

        /* read maintenance information */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_rdmntinfo")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_checkhdd")]
        public static extern short ds_checkhdd(ushort FlibHndl);

        /* format the Data Server's HDD */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_formathdd")]
        public static extern short ds_formathdd(ushort FlibHndl);

        /* create the directory in the Data Server's HDD */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_makehdddir")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_delhdddir")]
        public static extern short ds_delhdddir(ushort FlibHndl, [In, MarshalAs(UnmanagedType.AsAny)] Object a);

        /* change the current directory */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_chghdddir")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_lputhddfile")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_ldelhddfile")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_lgethostfile")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_rdm198hdddir")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_wrm198hdddir")]
        public static extern short ds_wrm198hdddir(ushort FlibHndl);

        /* read the connecting host number for the M198 operation */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_rdm198host")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_wrm198host")]
        public static extern short ds_wrm198host(ushort FlibHndl);

        /* write the connecting host number */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_wrhostno")]
        public static extern short ds_wrhostno(ushort FlibHndl, short a);

        /* search string in data server program */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_searchword")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_searchresult")]
        public static extern short ds_searchresult(ushort FlibHndl);

        /* read file in the Data Server's HDD */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_rdfile")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "ds_wrfile")]
        ...
        /* read number of node */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdnodenum")]
        public static extern short cnc_rdnodenum(out int a);

        /* read node informations */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdnodeinfo")]
        public static extern short cnc_rdnodeinfo(int a, [Out, MarshalAs(UnmanagedType.LPStruct)] ODBNODE b);

        /* set default node number */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_setdefnode")]
        public static extern short cnc_setdefnode(int a);

        /* allocate library handle 2 */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_allclibhndl2")]
...
#else
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_allclibhndl3")]
#endif
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_allclibhndl4")]
        ...
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_settimeout")]
        public static extern short cnc_settimeout(ushort FlibHndl, int a);

        /* reset all socket connection */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_resetconnect")]
        public static extern short cnc_resetconnect(ushort FlibHndl);

        /* get option state for FOCAS1/Ethernet */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_getfocas1opt")]
...
#elif WIN64
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdetherinfo")]
#else
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdetherinfo")]
#endif
...
#else
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_rdcncid")]
#endif
        public static extern short cnc_rdcncid( ushort FlibHndl, uint[] cncid);

        /* read program name under execution */
        [DllImport(/* "FWLIB64.dll" */ "libfwlib32-linux-x64.so.1.0.5", EntryPoint = "cnc_exeprgname2")]
